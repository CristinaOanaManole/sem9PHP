        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 col-sm-12 col-12 mx-auto">
                <div class="card login-content shadow-lg border-0">
                    ...
                    <form class="form-register border-light bg-light" action="user.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mx-auto">
                            <fieldset>
                                ...
                                <div class="px-4 m-1">
                                    ...
                                    <input class="m-3" type="text" name="lastName" id="lastName" placeholder="Indiquer votre nom" required="" minlength="4" maxlength="20" size="20"
                                     value="">
                                   
                                <label for="firstName" class="px-2">Votre prénom :<em>*</em></label>
                                <input type="text" name="firstName" id="firstName" placeholder="Indiquer votre prénom" required="" minlength="4" maxlength="20" size="20" 
                                value="">
                                ...
                                <div class="px-4 m-1">
                                    ...
                                    <input type="text" id="phone" name="phone" placeholder="0612345678" pattern="^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$" required>
                                </div>
                            </fieldset>
                                ...
                                <div class="container">
                                    <div class="px-1">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="date" class="mx-2" id="dateofBirth" name="dateofBirth" placeholder="jour/mois/année" pattern="[0-9]{1-2}" required=""><br> <!--  -->
                                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="px-1" id="" name="numberPE" placeholder="1234567Y" value="94567Y">
                                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <input type="number" id="" name="badges" placeholder="Combien des badges avez-vous ?" value="2" min="1" max="30">
                                        ...
                                        <div class="">
                                            <label for="comExp">
                                                ...
                                                <input type="radio" id="" class="px-4" name="optradio" value="Oui">Oui
                                                <input type="radio" id="" name="optradio" value="Non">Non
