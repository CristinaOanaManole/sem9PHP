            ...
            <div class="col-lg-6 col-md-8 col-sm-10 col-12 mx-auto">
                <div class="card login-content shadow-lg border-0">
                    ...
                    <form class="form-register border-light" action="index.php" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="">
                        <fieldset>
                            <legend class="text-center m-2">Contact</legend>

                                <div class="text-left">
                                   
                                    <label for="lastName">Votre nom : <em>*</em></label>
                                    <input type="text" name="lastName" id="lastName" placeholder="Indiquer votre nom" required="" minlength="4" maxlength="20" size="20" value="<?php echo !empty($lastName) ? $lastName : ''; ?>">
                                ...
                                <div class="text-left">
                                    <label for="firstName">Votre prénom :<em>*</em></label>
                                ...
                                <div class="text-left">
                                    <label for="address">Votre adresse :<em>*</em></label>
                                    <input type="text" id="address" name="address" placeholder="1 rue Colbert 75000 Paris" required>
                                </div>

                                <div class="text-left">
                                    <label for="phone">Votre téléphone :<em>*</em></label>
                                    <input type="text" id="phone" name="phone" placeholder="0612345678" required>
                                </div>
                                    </fieldset>

                                <fieldset>
                                    <legend class="text-center m-2">Informations personnelles</legend>
                                    <label for="dateofBirth">Votre date de naissance<em>*</em></label>
